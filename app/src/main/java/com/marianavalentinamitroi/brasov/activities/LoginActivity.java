...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
     ...
     *              - if the email address and the password correspond to one account, we'll land to the PresentationActivity
     */
    private void verifyFromSQLite(){
        ...
        if (databaseHelper.checkUser(email, password)) {
            ...
            Intent accountsIntent = new Intent(activity, PresentationActivity.class);
            /* send the email address that the user entered in the login form  with the intent, to be used in the  PresentationActivity view */
